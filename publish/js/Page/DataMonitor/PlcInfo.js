...
function LoadPlcDatas() {
    for (var i = 0; i < 3; i++) {
        var tableRow = {};
        tableRow["plcType"] = "首抄PLC";
        tableRow["plcName"] = "测试点1";
        tableRow["plcComuStatus"] = "<Img style='height:18px;width:18px;' src='../images/中断.png'/>";
        tableRow["plcDeviceStatus"] = "<Img style='height:18px;width:18px;' src='../images/中断.png'/>";
        tableRow["plcUpdateTime"] = "2017-2-13 13:20:30";
        tableRow["plcSidu"] = "未知";

        tableRow["plcYewei"] = "未知";
        tableRow["plcPower"] = "未知";
        tableRow["plcFreq"] = "未知";
        tableRow["plcShun"] = "未知";
        tableRow["plcTotal"] = "未知";
        tableRow["plcCtl"] = "未知";
        tableRow["plcShui"] = "未知";
        tableRow["plcPro"] = "未知";
        tableRow["plcShuiRun"] = "未知";
        tableRow["plcMark"] = "未知";
