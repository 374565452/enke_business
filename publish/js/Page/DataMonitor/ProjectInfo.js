...
function LoadProjectDatas() {
    var tableRow = {};
    tableRow["projectId"] = 1;
    tableRow["areaName"] = "测试区域";
    tableRow["areaCode"] = "测试所用编码";
    tableRow["projectInfo"] = "测试项目1";
    tableRow["deviceType"] = "广播设备";
    tableRow["deviceNum"] = 3;
    tableRow["installTime"] = "2017-2-13 13:20:30";
    tableRow["phone"] = "18732419879";
    tableRow["oper"] = " <img src='../Images/Detail.gif' alt='编辑' onclick='javascript:alert(\"功能开发中\");' />&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;<img src='../Images/Delete.gif' alt='删除' onclick='javascript:alert(\"功能开发中\");' />";
    //tableRow["removeUser"] = "";
    tableData.push(tableRow);
    var tableRow2 = {};
    tableRow2["projectId"] = 2;
    tableRow2["areaName"] = "测试区域";
    tableRow2["areaCode"] = "测试所用编码";
    tableRow2["projectInfo"] = "测试项目2";
    tableRow2["deviceType"] = "广播设备";
    tableRow2["deviceNum"] = 3;
    tableRow2["installTime"] = "2017-2-13 13:20:30";
    tableRow2["phone"] = "18732419879";
    tableRow2["oper"] = " <img src='../Images/Detail.gif'alt='编辑' onclick='javascript:alert(\"功能开发中\");' />&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;<img src='../Images/Delete.gif' alt='删除' onclick='javascript:alert(\"功能开发中\");' />";
    //tableRow["removeUser"] = "";
    tableData.push(tableRow2);
    var tableRow3 = {};
    tableRow3["projectId"] = 3;
    tableRow3["areaName"] = "测试区域";
    tableRow3["areaCode"] = "测试所用编码";
    tableRow3["projectInfo"] = "测试项目3";
    tableRow3["deviceType"] = "广播设备";
    tableRow3["deviceNum"] = 3;
    tableRow3["installTime"] = "2017-2-13 13:20:30";
    tableRow3["phone"] = "18732419879";
    tableRow3["oper"] = "<img src='../Images/Detail.gif' alt='编辑' onclick='javascript:alert(\"功能开发中\");' />&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;<img src='../Images/Delete.gif' alt='删除' onclick='javascript:alert(\"功能开发中\");' />";
    //tableRow["removeUser"] = "";
...
function btn_add_click() {
    $('#dlgProjectInfo').dialog({ title: "添加用户信息", closed: false });
}
/***添加按钮执行函数****/
